...
#define LWE_N1 663		// LWE dim
#define LWE_M 1024
#define LWE_N (((LWE_N1 + 15) >> 4) << 4)		// LWR dim (Number of LWE samples in pk)
#define LWE_L 256		// LWE_L1 * LWE_L2 = LWE_L
#define LWE_L1 16
#define LWE_L2 16		
#define LOG_Q 10
...
#ifdef KEM_CATEGORY3_N952f
#define PARAMNAME "Lizard.KEM_CATEGORY3_N952"
#define LWE_N 64		// LWE dim
#define LWE_M 128		// LWR dim (Number of LWE samples in pk)
#define LWE_L 64		// LWE_L1 * LWE_L2 = LWE_L
#define LWE_L1 8
#define LWE_L2 8
#define LOG_Q 11
#define _16_LOG_Q 5
...
#define RD_ADD 0x40 	// 2^(15 - LOG_P)
#define RD_AND 0xff80
#define HR 20			// Hamming weight of coefficient vector r
#define LOG_T 1
#define _16_LOG_T 15
#define T 2
#define DEC_ADD 0x4000	// 2^(15 - LOG_T)
